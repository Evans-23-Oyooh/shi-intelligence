...
<head>
    ...
    <title>shi Intelligence|Digital Forensics|account recoveries|intelligence|Assets Recovery Team</title>
                            ...
                            <div class="top-left">
                                ...
                                <section id="block-displayspresentattorneygeneralname" class="block block-block">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="block-title">Intelligence Team</h2>
                                            </div>
                                        </div>
                                    </div>
...
<script>
        ...
        <section class="banner">
            ...
            <section class="banner_bottom" style="position: relative; height: 70vh; overflow: hidden;">
                ...
                <div id="imageCarousel" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 1; overflow: hidden;">
                    <img src="./themes/custom/atg/img/shi9.avif" alt="Slide 1" style="width: 100%; height: 100%; object-fit: cover; position: absolute; animation: fadeInOut 15s infinite;">
                    <img src="./themes/custom/atg/img/shi9.avif" alt="Slide 2" style="width: 100%; height: 100%; object-fit: cover; position: absolute; animation: fadeInOut 15s infinite 5s;">
                    <img src="./themes/custom/atg/img/shi8.jpg" alt="Slide 3" style="width: 100%; height: 100%; object-fit: cover; position: absolute; animation: fadeInOut 15s infinite 10s;">
                </div>
                ...
                <div class="container" style="position: relative; z-index: 2; height: 100%; display: flex; align-items: center;">
                    <div class="row w-100">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="text-box" style="padding: 20px; border-radius: 10px; background: linear-gradient(to bottom right, rgba(255, 165, 0, 0.8), rgba(255, 140, 0, 0.7)); color: white; transition: all 0.3s ease;">
                                <h1>We Value Your Feedback</h1>
                                <p style="font-size: 15pt;">Let us know your thoughts about SANTOSHI HACKERS INTELLIGENCE (SHI). Your feedback helps us improve and serve you better.</p>
                                <form action="#" method="POST">
                                    <div class="form-group" style="margin-bottom: 15px;">
                                        <label for="name" style="font-size: 14pt;">Your Name</label>
                                        <input type="text" id="name" name="name" class="form-control" style="width: 100%; padding: 10px; border-radius: 5px;" placeholder="Enter your name" required>
                                    </div>
                                    <div class="form-group" style="margin-bottom: 15px;">
                                        <label for="email" style="font-size: 14pt;">Email Address</label>
                                        <input type="email" id="email" name="email" class="form-control" style="width: 100%; padding: 10px; border-radius: 5px;" placeholder="Enter your email" required>
                                    </div>
                                    <div class="form-group" style="margin-bottom: 15px;">
                                        <label for="comments" style="font-size: 14pt;">Your Comments</label>
                                        <textarea id="comments" name="comments" class="form-control" style="width: 100%; padding: 10px; border-radius: 5px;" rows="4" placeholder="Share your thoughts" required></textarea>
                                    </div>
                                    <button type="submit" class="btn btn-warning" style="font-size: 1.2rem; width: 100%; padding: 10px; border-radius: 5px;">Submit Feedback</button>
                                </form>
                            </div>
                        </div>
 ...
 <section class="banner_bottom">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="block-title text-left">Cybercrime Investigations and Solutions</h2>
            </div>

            <!-- Column 1: Cybercrime Cases -->
            <div class="col-md-4">
                <section class="block block-block" style="background-color: #d4edda; padding: 15px; border-radius: 10px; text-align: left;">
                    <h3>Cybercrime Cases</h3>
                    <p>SHI leverages advanced technology to investigate and resolve complex cybercrime cases:</p>
                    <ul>
                        <li>Uncovering ransomware attack perpetrators.</li>
                        <li>Tracing cryptocurrency fraud transactions.</li>
                        <li>Identifying actors behind phishing scams.</li>
                        <li>Tracking intellectual property theft across borders.</li>
                    </ul>
                </section>
            </div>

            <!-- Column 2: Recovery of Lost Accounts -->
            <div class="col-md-4">
                <section class="block block-block" style="background-color: #d1ecf1; padding: 15px; border-radius: 10px; text-align: left;">
                    <h3>Recovery of Lost Accounts</h3>
                    <p>SHI assists clients in recovering compromised or lost accounts:</p>
                    <ul>
                        <li>Restoring access to hacked social media accounts.</li>
                        <li>Recovering email accounts compromised by phishing.</li>
                        <li>Rebuilding access to bank accounts following identity theft.</li>
                        <li>Securing enterprise-level accounts from unauthorized access.</li>
                    </ul>
                </section>
            </div>

            <!-- Column 3: Drug Trafficking Investigations -->
            <div class="col-md-4">
                <section class="block block-block" style="background-color: #d4edda; padding: 15px; border-radius: 10px; text-align: left;">
                    <h3>Drug Trafficking Investigations</h3>
                    <p>Using advanced analytics and tracking, SHI uncovers drug trafficking networks:</p>
                    <ul>
                        <li>Tracing transactions via cryptocurrency and dark web.</li>
                        <li>Mapping supply chains and distribution networks.</li>
                        <li>Collaborating with law enforcement to gather evidence.</li>
                        <li>Identifying online marketplaces involved in illicit activities.</li>
                    </ul>
                </section>
            </div>
            </div>

            <!-- Column 4: Lost Identity -->
             <div class="row">
            <div class="col-md-4">
                <section class="block block-block" style="background-color: #d4edda; padding: 15px; border-radius: 10px; text-align: left;">
                    <h3>Lost Identity Recovery</h3>
                    <p>SHI helps victims regain control of their identities:</p>
                    <ul>
                        <li>Investigating cases of stolen identity.</li>
                        <li>Rebuilding digital profiles for affected individuals.</li>
                        <li>Identifying fraudulent activity linked to identity theft.</li>
                        <li>Providing preventive measures to secure personal data.</li>
                    </ul>
                </section>
            </div>

            <!-- Column 5: Kidnapping Cases -->
            <div class="col-md-4">
                <section class="block block-block" style="background-color:#d4edda; padding: 15px; border-radius: 10px; text-align: left;">
                    <h3>Kidnapping Investigations</h3>
                    <p>SHI assists in resolving kidnapping cases through:</p>
                    <ul>
                        <li>Using geolocation and tracking technology to trace victims.</li>
                        <li>Analyzing ransom communications for leads.</li>
                        <li>Collaborating with law enforcement to locate perpetrators.</li>
                        <li>Leveraging cyber-intelligence for rapid response.</li>
                    </ul>
                </section>
            </div>

            <!-- Column 6: Industry Threats -->
            <div class="col-md-4">
                <section class="block block-block" style="background-color: #d4edda; padding: 15px; border-radius: 10px; text-align: left;">
                    <h3>Threats to Industry Systems</h3>
                    <p>SHI safeguards industries from cyber threats through:</p>
                    <ul>
                        <li>Assessing vulnerabilities in critical systems.</li>
                        <li>Implementing advanced threat detection solutions.</li>
                        <li>Monitoring insider threats and access management.</li>
                        <li>Providing 24/7 incident response and recovery services.</li>
                    </ul>
                </section>
            </div>
            </div>

            <!-- Column 7: Network Security -->
             <div class="row">
            <div class="col-md-6">
                <section class="block block-block" style="background-color: #dff0d8; padding: 15px; border-radius: 10px; text-align: left;">
                    <h3>Network Security & Vulnerability Scanning</h3>
                    <p>SHI ensures robust network security through:</p>
                    <ul>
                        <li>Conducting comprehensive vulnerability scans.</li>
                        <li>Implementing firewall and intrusion detection systems.</li>
                        <li>Penetration testing to assess security robustness.</li>
                        <li>Providing detailed reports and solutions for improvement.</li>
                    </ul>
                </section>
            </div>
            <div class="col-md-6">
                <section class="block block-block" style="background-color: #dff0d8; padding: 15px; border-radius: 10px; text-align: left;">
                    <h3>Recovery of Digital Assets</h3>
                    <p>SHI specializes in recovering lost or inaccessible digital assets, including:</p>
                    <ul>
                        <li>Pi Network Tokens</li>
                        <li>World Coin</li>
                        <li>Dogecoin</li>
                        <li>USDT (Tether)</li>
                        <li>Bitcoin and Ethereum</li>
                        <li>Other cryptocurrency wallets and tokens</li>
                    </ul>
                    <p>Our team utilizes advanced blockchain tracing techniques and collaborates with global partners to recover your assets efficiently and securely.</p>
                </section>
            </div>
        </div>
        <div class="row">
            <div class="container">
                <div class="button" style="text-align: center; margin-top: 20px;">
                    <button style="background-color: orange; padding: 10px 20px; font-size: 16px; font-weight: bold; cursor: pointer; transition: background-color 0.3s ease, transform 0.2s ease; border: none; outline: none;">
                        <a href="caseform.php" style="color: white; text-decoration: none;">Book Now</a>
                    </button>
                </div>
            </div>
        </div>
