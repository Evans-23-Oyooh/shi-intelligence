...
<head>
    ...
    <title>shi Intelligence|Digital Forensics|account recoveries|casese Filling |Hacking Cases|Cybercrime cases Report</title>
                            ...
                            <div class="top-left">
                                ...
                                <section id="block-displayspresentattorneygeneralname" class="block block-block">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="block-title">Terms and Services applies</h2>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    window.dispatchEvent(new Event('resize'));
        ...
        <section class="banner">
            ...
            <section class="views-element-container block block-block" id="block-views-block-banner-block" style="background: url('./themes/custom/atg/img/logo-Photoroom.png');">
        ...
        <section class="banner_bottom">
            <div class="container">
                <div class="row">
                    <!-- Block 1 -->
                    <section id="block-consumerprotectioninformationblock" class="block block-block" style="background-color: #d1ecf1; text-align: left; padding: 20px;">
                        <div class="space20"></div>
                        <div class="content">
                            <h3>Terms and Conditions for Registering a Case</h3>
                            <ol class="terms-list">
                                <li>You must provide accurate details of the incident or case.</li>
                                <li>All cases must be registered within 30 days of the occurrence.</li>
                                <li>The case must involve criminal activity, fraud, or financial misconduct.</li>
                                <li>You agree to cooperate fully with SHI during the investigation process.</li>
                                <li>Evidence provided must be authentic and relevant to the case.</li>
                                <li>SHI will not be held responsible for any loss or damage incurred during the investigation.</li>
                                <li>Confidentiality of your case will be maintained to the highest standards.</li>
                                <li>False or misleading information provided will result in immediate dismissal of the case.</li>
                                <li>You authorize SHI to share information with relevant authorities when required.</li>
                            </ol>
                        </div>
                    </section>
                    
                    <!-- Block 2 -->
                    <section id="block-fileacomplaintblock" class="block block-block" style="background-color: #d1ecf1; text-align: left; padding: 20px;">
                        <div class="space20"></div>
                        <div class="content">
                            <h3>Terms and Conditions for Registering a Case (Continued)</h3>
                            <ol class="terms-list">
                                <li>All cases will be investigated in accordance with applicable laws and regulations.</li>
                                <li>You will be notified of any developments in your case within reasonable timeframes.</li>
                                <li>SHI reserves the right to withdraw from any investigation if legal or ethical issues arise.</li>
                                <li>Registration of a case does not guarantee a positive outcome.</li>
                                <li>Any fees or charges related to the investigation will be communicated upfront.</li>
                                <li>By registering, you agree to the terms and conditions of SHI's service agreement.</li>
                            </ol>
                        </div>
                    </section>
                    
                    <!-- Block 3: Case Registration Form -->
                    <section id="block-ourofficeblock" class="block block-block" style="background-color: #d4edda; text-align: left; padding: 20px;">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="block-title">Case Registration</h2>
                                </div>
                            </div>
                        </div>
                        <div class="space20"></div>
                        <div class="content">
                            <p>Please fill in the form below to register your case for investigation. All fields are mandatory.</p>
                            <form action="/submit-case" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="case_type" name="case_type" required>
                                        ...
                                        <option value="other">Globa Cyber Attack</option>
                                        <option value="other">Yahoo data bridge</option>
                                        <option value="other"></option>
                                        <option value="other">Other</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="email">Uppload File</label>
                                    <input type="file" class="form-control" id="file" name="fie" placeholder="Upload any supportive file">
                                </div>
                                <div class="form-group">
                                    <label for="case_description">Case Description</label>
                                    <textarea class="form-control" id="case_description" name="case_description" rows="4" placeholder="Provide a brief description of the case" required></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>
                                        ...
                                        I have read and agree to the <a href="#terms-and-conditions" data-toggle="modal" data-target="#termsModal">Terms and Conditions</a>.
                                    </label>
                                </div>
