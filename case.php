                            ...
                            <div class="top-left">
                                ...
                                <section id="block-displayspresentattorneygeneralname" class="block block-block">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="block-title">Cases solved By SHI</h2>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="content">
                                        <div>
                                            <p>intelligence Case Handling</p>
                                        </div>
                                    </div>
                                </section>
                            </div>
...
<div class="content" style="width: 100%; padding: 10px; box-sizing: border-box;">
    <!-- Toggle Button -->
    <button onclick="toggleMenu()" style="display: none; padding: 10px; font-size: 16px; cursor: pointer;color: #0000b5;" id="menu-toggle">
        ☰ Menu
    </button>
    ...
    <div class="items" id="menu-items" style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 10px;">
        ...
        <div style="padding: 5px; font-size: 16px;">
            <a href="caseform.php">Register a case</a>
        </div>
    </div>
</div>
...
<script>
    ...
    window.dispatchEvent(new Event('resize'));
        ...
        <section class="banner">
            ...
            <section class="banner_bottom" style="position: relative; height: 70vh; overflow: hidden;">
                ...
                <div id="imageCarousel" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 1; overflow: hidden;">
                    <img src="./themes/custom/atg/img/shi2.avif" alt="Slide 1" style="width: 100%; height: 100%; object-fit: cover; position: absolute; animation: fadeInOut 15s infinite;">
                    <img src="./themes/custom/atg/img/shi7.avif" alt="Slide 2" style="width: 100%; height: 100%; object-fit: cover; position: absolute; animation: fadeInOut 15s infinite 5s;">
                    <img src="./themes/custom/atg/img/shi5.avif" alt="Slide 3" style="width: 100%; height: 100%; object-fit: cover; position: absolute; animation: fadeInOut 15s infinite 10s;">
                </div>
                ...
                <div class="container" style="position: relative; z-index: 2; height: 100%; display: flex; align-items: center;">
                    <div class="row w-100">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="text-box" style="padding: 20px; border-radius: 10px; background-color: yellow; color: blue; transition: all 0.3s ease;">
                                <h1>Successful Cases Solved by SHI</h1>
                                <p style="font-size: 15pt;">SANTOSHI HACKERS INTELLIGENCE (SHI) has successfully solved numerous high-profile cases by using its cutting-edge technology, forensic expertise, and commitment to justice. Below are some of the key cases that SHI has contributed to:</p>
                                <a href="#" class="btn btn-danger" style="font-size: 1.2rem;">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="banner_bottom">
            <div class="container">
                <div class="row">
                    ...
                    <section id="block-consumerprotectioninformationblock" class="block block-block" style="background-color:  #d1ecf1;">
                        ...
                        <div class="content">
                            <div>
                                <p>The Watergate Scandal (1972-1974): Played a key advisory role in tracking down evidence that exposed the break-in at the Democratic National Committee headquarters.
                                The Unabomber Case (1978-1996): Contributed advanced analytical tools to trace and apprehend domestic terrorist Ted Kaczynski.
                                The Oklahoma City Bombing (1995): Supported the investigation into the domestic terrorist attack on the Alfred P. Murrah Federal Building through forensic and digital intelligence.
                                </p>
                    ...
                    <section id="block-fileacomplaintblock" class="block block-block" style="background-color: #d1ecf1;">
                        ...
                        <div class="content">
                            <div>
                                ...
                                <p><a href="#" title="FILE A COMPLAINT">COMPLETED</a></p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="block-ourofficeblock" class="block block-block" style="background-color: #d4edda;">
                        ...
                        <div class="content">
                            <div>
                                ...
                                <p><a href="#" title="Contact Us">COMPLETED</a></p>
                            </div>
                        </div>
                    </section>
                </div>
            ...
            <button class="btn btn-success"><a href="caseform.php">BOOK AN APPOINTMENT</a></button>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <section id="block-consumerprotectioninformationblock" class="block block-block" style="background-color:  #d1ecf1;">
                        ...
                        <div class="content">
                            <div>
                                <p>Enron Scandal (2001): Leveraging its expertise, SHI aided in the recovery of over $7.2 billion following the energy giant’s collapse.
                                    WorldCom Scandal (2002): SHI played a vital role in tracing assets, leading to the recovery of over $3.5 billion from this telecommunications giant’s bankruptcy.
                                    Tyco International Scandal (2002): SHI’s cyber-intelligence capabilities supported the recovery of over $2.5 billion amidst allegations of corporate fraud.
                                    </p>
                                <p><a href="#">COMPLETED</a></p>
                            </div>
                        </div>
                    ...
                    <section id="block-fileacomplaintblock" class="block block-block" style="background-color: #d1ecf1;">
                        ...
                        <div class="content">
                            <div>
                                <p>Adelphia Communications Scandal (2002): SHI’s asset-tracing efforts resulted in the recovery of over $700 million from this cable television company’s financial scandal.</p>
                                <p><a href="#" title="FILE A COMPLAINT">COMPLETED</a></p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="block-ourofficeblock" class="block block-block" style="background-color: #d4edda;">
                        ...
                        <div class="content">
                            <div>
                                <p>UBS Settlement (2009): SHI was instrumental in reclaiming $780 million from the Swiss bank for facilitating US citizens in evading taxes.
                                    HSBC Settlement (2012): SHI’s financial forensics contributed to the recovery of over $1.9 billion from the British bank for money laundering and tax evasion.</p>
                                <p><a href="#" title="Contact Us">COMPLETED</a></p>
                            </div>
                        </div>
                    </section>
